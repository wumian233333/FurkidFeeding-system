...
public interface AnimalMapper {
    ...
    @Insert("insert IGNORE into t_animal(id,animalname,zhonglei,pinzhong,age,sex,weight,id_device) values  (#{id},#{animalname},#{zhonglei},#{pinzhong},#{age},#{sex},#{weight},#{id_device})")
